...
class VerifierService:
    ...
    async def verify_definition_guess(self, topic: Topic, definition_guess: DefinitionGuess | DefinitionGuessCreate):
        ...
        definition_guess_dict["sentences"] = [
            a.model_dump(include={"text_with_gap", "gap_filler_form"}) for a in definition_guess.sentences
        ]
        definition_guess_dict["alternatives"] = [
            a.model_dump(include={"value", "explanation"}) for a in definition_guess.alternatives
        ]
        definition_guess_dict["distractors"] = [
            a.model_dump(include={"value", "explanation"}) for a in definition_guess.distractors
        ]
