...
from dependencies import AppStateDep, AudioFileServiceDep, TopicServiceDep, NativeTopicServiceDep, not_production
...
async def post(
    service: LetterShuffleTranslationServiceDep, topic_service: TopicServiceDep, native_topic_service: NativeTopicServiceDep, value_create: LetterShuffleSetTranslationCreate
) -> LetterShuffleSetTranslation:
    return await service.post(topic_service, native_topic_service, value_create)
