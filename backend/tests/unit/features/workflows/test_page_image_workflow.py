...
async def test_generate_image(
    page_image_workflow: PageImageWorkflow, mocker_ai_model: MockerAIModel, mocker_image_generator: MockerImageGenerator
):
    ...
    assert blob.content == b"Mocked image bytes"
